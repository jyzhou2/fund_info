...
Route::group([
	...
	Route::group([
		...
		// 编辑文章分类
		Route::get('/edit/{cate_id?}', 'AcategoryController@edit')->name('admin.article.acategory.edit');
		// 删除文章分类
	...
	Route::group([
		...
		// 编辑文章
		Route::get('/edit', 'ArticleController@edit')->name('admin.article.article.edit');
		// 删除文章
