            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="{{route('admin.positions.user_trajectory_info',[$uid,$look_date])}}?rent_name={{$rent_name}}">轨迹详情</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="ibox float-e-margins">
                    <ul class="layui-tab-title">
                        @foreach ($map_info as $g)
                            <li @if($map_id==$g['map_id'])class="layui-this"@endif ><a
                                        href="{{route('admin.positions.user_trajectory_info',[$uid,$look_date,$g['map_id']])}}?rent_name={{$rent_name}}">{{$g['map_name']}}</a></li>
                        @endforeach
                    </ul>
                    <div id="show-msg">
                        <label>昵称：{{$rent_name}}</label>
                        <label>使用日期：{{$look_date}}</label>
                    </div>
