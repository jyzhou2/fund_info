            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="{{route('admin.positions.backup_trajectory_info',[$rent_id])}}">轨迹详情</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="ibox float-e-margins">
                    <ul class="layui-tab-title">
                        @foreach ($map_info as $g)
                            <li @if($map_id==$g['map_id'])class="layui-this"@endif ><a href="{{route('admin.positions.backup_trajectory_info',[$rent_id,$g['map_id']])}}">{{$g['map_name']}}</a></li>
                        @endforeach
                    </ul>
                    <div id="show-msg">
                        <label>租赁者姓名：{{$rent_info->RENT_NAME}}</label>
                        <label>租赁时间：{{$rent_info->RENT_STARTTIME}}</label>
                        <label>归还时间：{{$rent_info->back_time}}</label>
